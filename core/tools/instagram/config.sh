...
#    cp -r $PREFIX/lib/python3.9/site-packages/instagram_py-2.0.7-py3.10.egg-info ${CWD}/assets
...
#    sudo cp -r $PREFIX/lib/python3.9/site-packages/instagram_py-2.0.7-py3.10.egg-info ${CWD}/assets
